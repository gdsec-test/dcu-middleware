...
class AppConfig(object):
    ...
    ENRICH_ON_SUBDOMAIN = {'godaddysites.com', 'go.studio', 'secureserversites.net', 'myftpupload.com', 'mywebsitetransfer.com'}
    ...
    CMAP_V2_SERVICE = 'https://cmapv2.cset.int.dev-gdcorp.tools'
...
class ProductionAppConfig(AppConfig):
    ...
    CMAP_V2_SERVICE = 'https://cmapv2.cset.int.gdcorp.tools'
...
class OTEAppConfig(AppConfig):
    ...
    CMAP_V2_SERVICE = 'https://cmapv2.cset.int.ote-gdcorp.tools'
...
class TestAppConfig(AppConfig):
    ...
    CMAP_V2_SERVICE = 'https://cmapv2.cset.int.test-gdcorp.tools'
...
class UnitTestAppConfig():
    ...
    ENRICH_ON_SUBDOMAIN = {'godaddysites.com', 'go.studio', 'secureserversites.net', 'mywebsitetransfer.com'}
